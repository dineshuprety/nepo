...
(function (factory) {
  ...
  var Nepo = /*#__PURE__*/function () {
    function Nepo(element, options) {
      ...
      this._init(); // replace inputToNumber


      this._changeInputToNumber(); //only numeric (0-9) in HTML
    ...
    _createClass(Nepo, [{
      ...
      value: function _init() {
        ...
        var settings = this.options; // new nepoElement

        var nepoElement = $('<div class="nepo-element"></div>');
        this.main.on('keypress keydown keyup', function () {
          // make empty nepo element
          nepoElement.remove(); //checking for valid number
      ...
      key: "_changeInputToNumber",
      value: function _changeInputToNumber() {
      ...
      key: "_changeInputTypeToText",
      value: function _changeInputTypeToText() {
